...
--   s({ trig = "template_koma", wordTrig = true, dscr = 'koma_env letter' },
--     fmta([[
-- % koma_env.tex
-- \documentclass[
--   fontsize=11pt,
...
--
-- \setkomavar{fromname}{Mainak Mandal}
-- \setkomavar{fromaddress}{PhD Candidate\\ Institute for Scientific Computing  \\ 01062 Dresden}
-- \setkomavar{fromphone}{+49 351 46342378}
-- \setkomavar{fromemail}{mainak.mandal@tu-dresden.de}
--
-- \begin{document}
--
-- \begin{letter}{Jacket address}
--
